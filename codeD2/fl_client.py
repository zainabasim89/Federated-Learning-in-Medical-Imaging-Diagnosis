...
class EarDiseaseFlowerClient(fl.client.NumPyClient):
    """
    Standard FedAvg client for the multiclass ear disease task
    (class count/names are supplied by the dataset — e.g. 4
    classes for the Chile dataset, 5 for Kaggle's Otoscopic_Data
    which adds a Normal class alongside 4 disease classes).
